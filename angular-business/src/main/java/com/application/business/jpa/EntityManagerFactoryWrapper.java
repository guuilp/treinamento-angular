...
public class EntityManagerFactoryWrapper {
    ...
    private static EntityManagerFactory getFactory() {
        ...
        if (emf == null) {
            ...
            if ("true".equals(System.getProperty("dbmanager"))) {
                try {
    ...
    protected static void executeDatabaseManager() throws Exception {

        DatabaseManagerSwing manager = new DatabaseManagerSwing(new JFrame("Memory database manager"));
        manager.main();
